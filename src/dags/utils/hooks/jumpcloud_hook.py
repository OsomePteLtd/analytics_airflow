...
class JumpcloudHook(BaseHook):
    ...
    def system_users_request(self,
        ...
        """
        This endpoint returns all system users

        Method docs:
        https://docs.jumpcloud.com/api/1.0/index.html#tag/Systemusers
    ...
    def get_full_system_users_list(self) -> list:
        ...
        while skip_val != total_count:
            response = self.system_users_request(
                skip=skip_val,
                limit=100)
